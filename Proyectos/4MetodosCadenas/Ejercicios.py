...
nombre completo del usuario tres veces, una con todas
...
por pantalla <NOMBRE> tiene <n> letras, donde <NOMBRE> es
el nombre de usuario en mayúsculas y <n> es el número de
...
del país +34, y la extensión tiene dos dígitos (por
ejemplo +34-913724710-56). Escribir un programa que
pregunte por un número de teléfono con este formato
...
correo electrónico con el mismo nombre (la parte delante
...
el número de unidades con tres dígitos y el coste
